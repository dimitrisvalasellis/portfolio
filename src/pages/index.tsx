...
export default function Home() {
  ...
  return (
    ...
    >
      {/* Header Wrapper */}
      <div className="w-full fixed z-50 top-6 flex justify-center">
        {/* Header Section */}
        <header className="flex w-11/12 md:w-fit h-[50px] justify-between items-center px-4 py-7 rounded-full mx-auto border-2 border-gray-400 bg-gray-100 bg-opacity-100 backdrop-blur-sm shadow-2xs shadow-gray-400/50">
          ...
          <div className="hidden md:flex flex-row items-center gap-10 lg:gap-24">
            ...
            <Link
              href="https://github.com/dimitrisvalasellis"
              rel="noopener noreferrer"
              target="_blank"
              className="font-sans text-gray-950 hover:text-gray-800 duration-100"
        ...
        {isMenuOpen && (
          <nav
            id="mobile-menu"
            className="md:hidden absolute top-[70px] bg-gray-100 w-11/12 rounded-lg border-2 border-gray-400 flex flex-col items-center gap-4 py-4 transition-all duration-300 ease-in-out"
          >
            <a
              href="#about"
        ...
        <main className="flex flex-col justify-center m-0 p-0">
          ...
          >
            ...
            <p className="text-gray-600 font-normal mb-5 px-4">
              ...
              <a
                href="mailto:dimvalas.me@gmail.com"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-950 hover:text-gray-800 duration-100"
              >
                dimvalas.me@gmail.com
              </a>
            </p>
            <div className="flex justify-center gap-4 py-2">
              {/* Discord Badge via shields.io */}
              <a
                href="https://discord.com/users/@me?add_friend=dimvalas.me"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Add dimvalas.me on Discord"
              >
                <img
                  src="https://img.shields.io/badge/Discord-dimvalas.me-5865F2?style=for-the-badge&logo=discord&logoColor=white"
                  alt="Discord: dimvalas.me"
                  className="h-9"
                />
              </a>
              {/* Instagram Badge via shields.io */}
              <a
                href="https://www.instagram.com/dimvalas.me"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Link to Dimitris's Instagram profile"
              >
                <img
                  src="https://img.shields.io/badge/Instagram-@dimvalas.me-E4405F?style=for-the-badge&logo=instagram&logoColor=white"
                  alt="Instagram: @dimvalas.me"
                  className="h-9"
                />
              </a>
            </div>
